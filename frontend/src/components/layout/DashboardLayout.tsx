  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5] flex flex-col font-sans antialiased selection:bg-black selection:text-white">
      ...
      <div className="flex-1 flex w-full">
        ...
        >
          <div className="p-3 flex items-center justify-between border-b border-gray-100 hidden lg:flex">
            {!collapsed && (
              <span className="text-xs font-bold uppercase tracking-wider text-gray-400 px-2">
                Menu Utama
              </span>
            )}
            <button
              ...
              className="p-1.5 hover:bg-gray-100 text-gray-500 hover:text-black rounded-lg transition-colors mx-auto cursor-pointer"
            >
