  ...
  return (
    <div className="relative">
      <input
        ...
        disabled={disabled}
        className={`w-full pr-10 border border-gray-300 rounded-lg px-3 py-2 text-sm font-mono text-gray-800 focus:outline-hidden focus:ring-2 focus:ring-black ${
...
export function Badge({ status }: { status: string }) {
  ...
  if (s === "active" || s === "completed" || s === "paid") {
    return (
      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-100 text-emerald-800 border border-emerald-200 uppercase tracking-wider whitespace-nowrap">
        <CheckCircle2 className="w-3 h-3" /> Active
      </span>
    );
  }
  if (s === "pending" || s === "pending_payment" || s === "pending_transfer") {
    return (
      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-100 text-amber-800 border border-amber-200 uppercase tracking-wider whitespace-nowrap">
  ...
  if (s === "expired") {
    return (
      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-red-100 text-red-800 border border-red-200 uppercase tracking-wider whitespace-nowrap">
  ...
  if (s === "suspended") {
    return (
      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-rose-100 text-rose-800 border border-rose-200 uppercase tracking-wider whitespace-nowrap">
  ...
  if (s === "transferred") {
    return (
      <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-blue-100 text-blue-800 border border-blue-200 uppercase tracking-wider whitespace-nowrap">
        <ArrowRightLeft className="w-3 h-3" /> Transferred
      </span>
    );
  }
  return (
    <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-gray-100 text-gray-700 border border-gray-200 uppercase tracking-wider whitespace-nowrap">
      {s || "unknown"}
    </span>
  );
}
