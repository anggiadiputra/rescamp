      ...
      <div className="max-w-md mx-auto mt-16 px-4">
        <Card>
          <div className="text-center">
            ...
            <h1 className="text-xl font-bold text-gray-900">Link Terkirim!</h1>
            <p className="text-xs text-gray-500 mt-2">
              Jika email <strong>{email}</strong> terdaftar, link reset password telah dikirim. Cek inbox dan folder spam Anda.
            </p>
            <Link to="/login" className="inline-block mt-4 text-sm font-semibold text-black hover:underline">← Kembali ke Login</Link>
          </div>
        </Card>
      </div>
    );
